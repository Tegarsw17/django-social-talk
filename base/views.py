...
#     {'id': 2, 'name': 'lets learn API with me'},
#     {'id': 3, 'name': 'What is frontend!'},
#     {'id': 4, 'name': 'Why we still here?'},
# ]
...
def home(request):
    ...
    data = {'rooms': rooms, 'topics': topics,
...
def room(request, pk):
    ...
    data = {'room': room, 'roomMessages': roomMessages,
